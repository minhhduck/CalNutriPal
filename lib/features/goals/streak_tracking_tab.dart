...
class _StreakTrackingTabState extends State<StreakTrackingTab> {
  ...
  /// Build milestone progress section
  Widget _buildMilestoneProgress() {
    final nextMilestone = widget.streakData.nextMilestone;
    final progress = widget.streakData.milestoneProgress;
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                nextMilestone <= 30 ? Colors.green : Colors.orange,
              ),
            ),
          ),
          Padding(
  ...
  /// Get appropriate achievement message based on current streak
  String _getStreakAchievementMessage() {
    final streak = widget.streakData.currentStreak;
    if (streak == 0) {
      return "Start your streak today!";
    } else if (streak == 1) {
      return "Great start! First day logged.";
    } else if (streak <= 3) {
      return "Good progress! Keep it up!";
    } else if (streak <= 7) {
      return "You're building momentum!";
    } else if (streak <= 14) {
      return "You're on fire! ${streak} days straight!";
    } else if (streak <= 21) {
      return "Amazing dedication! ${streak} day streak!";
    } else if (streak <= 30) {
      return "Incredible consistency!";
    } else if (streak <= 60) {
      return "You're a logging champion!";
    } else if (streak <= 90) {
